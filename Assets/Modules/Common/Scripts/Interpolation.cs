...
public class Interpolation
{
    ...
    public static float LerpClampedWithInterpolation(float x, float a, float b, Type type = Type.Cubic, Mode mode = Mode.Out)
    {
    ...
    public float LerpClampedWithInterpolation(float x, float a, float b)
    {
    ...
    public Vector2 LerpClampedWithInterpolation(float t, Vector2 a, Vector2 b)
    {
        return new Vector2(LerpClampedWithInterpolation(t, a.x, b.x), LerpClampedWithInterpolation(t, a.y, b.y));
    }
